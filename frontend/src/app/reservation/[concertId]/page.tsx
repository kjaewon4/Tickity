// src/app/reservation/ReservationDetail.tsx
...
const ReservationDetail = () => {
  ...
  if (!concert || !ticketInfo) return <div className="p-6">Loading...</div>;
                ...
                <table className="w-full table-fixed text-left">
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <th className="bg-gray-50 p-3 font-medium">E-mail</th>
                    ...
                    <tr>
                      ...
                      <th className="bg-gray-50 p-3 font-medium">주소</th>
